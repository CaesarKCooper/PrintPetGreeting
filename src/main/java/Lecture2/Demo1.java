...
// Method should do what it is called
// Method should be camel cased

    //Creating a method
    public static int giveMeBackNumber() {
    return  0;
    }

    public static String takeANumberAndPrintThatShit(int x){
        return "This is a number you gave to me: " + x;
    }

    public static void main(String[] args) {

        //use or invoke or call the method-
        giveMeBackNumber();
        System.out.println(giveMeBackNumber());
        System.out.println();
    }
